...
#### Написать свою реализацию ps ax используя анализ /proc. Результат - рабочий скрипт который можно запустить
...
Реалезуем упрощенную версию lsof, которая будет выводить список используемых файлов всеми процессами.
